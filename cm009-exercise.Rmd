...
tibble(let = letters,
       ...
       comb = paste(let, num)) #can use paste0 to remove the space between
```
...
gather(lotr_untidy, key = "Gender", value="Word", Female:Male) #range of columns
gather(lotr_untidy, key = "Gender", value="Word", contains("ale")) #specifies string
```
