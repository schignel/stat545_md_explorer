...
1.  Instead of a histogram, let's create a kernel density plot. Note: In this case we also superimposed this on the histogram. Rescaled the histogram Count values to a density/percentage using the "..density" option
